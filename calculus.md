# Chapter_1. Brief History
  ...
  * ## Before Calculus
    ...
    * In 1656, John Wallis published his Arithemtica infinitorum, in which he displayed many ideas that were to lead to the integral calculus of Newton, including the famous **Wallis Product** which gives: [reference](https://www.jstor.org/stable/25759727?seq=1)
```math
