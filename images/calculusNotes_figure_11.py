...
data = [
    ...
    ["1/2", 1, "", r"$\frac{3}{2}$", "", r"$\frac{3 \cdot 5}{2 \cdot 4}$", "", r"$\frac{3 \cdot 5 \cdot 7}{2 \cdot 4 \cdot 6}$", "", r"$\frac{3 \cdot 5 \cdot 7 \cdot 9}{384}$", ""],
    ["1", 1, r"$\frac{3}{2}$", 2, r"$\frac{5}{2}$", 3, r"$\frac{7}{2}$", 4, r"$\frac{9}{2}$", 5, r"$s$"],
    ["3/2", 1, "", r"$\frac{5}{2}$", "", r"$\frac{5 \cdot 7}{2 \cdot 4}$", "", r"$\frac{5 \cdot 7 \cdot 9}{2 \cdot 4 \cdot 6}$", "", r"$\frac{3465}{384}$", ""],
    ["2", 1, r"$\frac{15}{8}$", 3, r"$\frac{35}{8}$", 6, r"$\frac{63}{8}$", 10, r"$\frac{99}{8}$", 15, r"$\frac{s^2 + s}{2}$"],
    ["5/2", 1, "", r"$\frac{7}{2}$", "", r"$\frac{7 \cdot 9}{2 \cdot 4}$", "", r"$\frac{7 \cdot 9 \cdot 11}{2 \cdot 4 \cdot 6}$", "", r"$\frac{9009}{384}$", ""],
