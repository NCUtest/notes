...
ax.annotate(r"$\longleftarrow\text{n}\longrightarrow$", xy=(-0.05, 0.5), xycoords='axes fraction', ha='center', va='center', fontsize=12, rotation='vertical')
...
# Save the figure
plt.savefig('/mnt/c/Users/user/Desktop/wujiaqi_personal_files/notes/images/calculusNotes_figure_2.svg', format='svg', bbox_inches='tight', pad_inches=0)
