...
```math
\frac{\frac{1 \cdot 3 \cdot 5 \cdot 7 \cdots n}{2 \cdot 4 \cdot 6 \cdot 8 \cdots \left( n-1 \right)}}{\frac{1 \cdot 3 \cdot 5 \cdot 7 \cdots n}{2 \cdot 4 \cdot 6 \cdot 8 \cdots \left( n-1 \right)}}
```
